...
public class AgendamentoManutencao {
    ...
    public static AgendamentoManutencao fromRequest(AgendamentoRequest request) {
        AgendamentoManutencao entity = new AgendamentoManutencao();
        entity.setNomeCompleto(request.getNomeCompleto());
        entity.setEmail(request.getEmail());
        entity.setTelefone(request.getTelefone());
        entity.setTipoEquipamento(request.getTipoEquipamento());
